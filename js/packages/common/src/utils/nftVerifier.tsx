import { getNameAccountKey, getHashedName, NameRegistryState } from "@bonfida/spl-name-service";
...
export async function getNftNameRecordKey(imgUrl: string): Promise<PublicKey> {
  return getNameAccountKey(await getHashedName(imgUrl), NFT_VERIFIER, NFT_VERIFIER_TLD)
}
