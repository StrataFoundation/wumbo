...
const Footer = React.memo(({ logoColor = "white" }: { logoColor?: "black" | "white" }) => (
  <div
  ...
  >
    ...
    <div className="flex flex-row justify-center">
      <a target="_blank" rel="noreferrer" href="https://twitter.com/teamwumbo">
        <img className="mr-2" src={logoColor == "white" ? twitterLogo : twitterLogoBlack} alt="twitter" width="30" />
      </a>
      <a target="_blank" rel="noreferrer" href="https://discord.gg/S8wJBR2BQV">
        <img className="ml-2" src={logoColor == "white" ? discordLogo : discordLogoBlack} alt="discord" width="30" />
      </a>
    </div>
  </div>
));
