...
export function halley_iteration(x: any, w_initial: any, max_iters: any) {
  var w = w_initial,
    i;
...
export function gsl_sf_lambert_W0_e(x: any) {
...
export function gsl_sf_lambert_Wm1_e(x: any) {
  var result = {} as any;
...
export function gsl_sf_lambert_W0(x: any) {
  return gsl_sf_lambert_W0_e(x).val;
}

export function gsl_sf_lambert_Wm1(x: any) {
