...
export const BetaDownlaodModal = () => {
  const { modalType, hideModal } = useModal();

  return (
    <Modal
      size="3xl"
      isOpen={modalType === "BetaDownload"}
      onClose={() => hideModal()}
    >
      <ModalOverlay />
      <ModalContent>
        ...
        <ModalBody>
          ...
          >
            ...
            <Box>
              ...
              <Text>
                Once on the Extensions page, make sure you enable the Developer
                Mode switch.
              </Text>
            ...
            <Box>
              ...
              <Text>
                Click on “Load unpacked” on the top left of the page. This will
                open your file browser. Navigate to the folder you just unpacked
                (previously dist.zip). Click on that file and click “Select.”
                This will install the extension to Chrome.
              </Text>
