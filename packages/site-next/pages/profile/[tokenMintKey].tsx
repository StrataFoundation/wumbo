...
const TokenMintProfile: NextPage = ({
  name,
  image,
  description,
}: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  const router = useRouter();
  const { tokenMintKey: tokenMintKeyRaw } = router.query;
  const tokenMintKey = usePublicKey(tokenMintKeyRaw as string);
...
export default TokenMintProfile;
