...
const TagGradients: Record<TokenTier, string> = {
  "Platinum": "conic-gradient(from -0.22deg at 48.39% 48.72%, #7C9DBF 0deg, #A3D0E6 138.61deg, #40679C 207.87deg, #4D6F88 257.83deg, #576D88 360deg), linear-gradient(185.95deg, #824C17 -3.23%, #D6B23F 5.3%, #FCFBE6 18.62%, #FDFEF9 24.45%, #FCFBE6 31.65%, #E6C970 55.56%, #F8E39F 67.64%, #AC874D 81.76%);",
  "Default": "green.500"
}

export const StatCard = ({ _hover, tag, tier, label, value, ...flexProps }: IStatCardProps) => {
  const Inner = <Flex
