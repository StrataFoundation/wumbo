...
function getBackgroundColor(elm: HTMLElement | null | undefined): string | undefined {
...
export function PriceButton({
  ...
  const backgroundColor = useMemo(() => getBackgroundColor(buttonTarget) || "white", [buttonTarget]);
  return (
    <Center
      h={`${h}px`}
