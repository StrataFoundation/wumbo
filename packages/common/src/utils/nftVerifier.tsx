...
import { AccountFetchCache, decodeMetadata } from "@strata-foundation/spl-utils";
...
export async function getNftMint(
  ...
  const metadata = metadataKey && await cache.search(metadataKey, (pubkey, account) => ({ pubkey, account, info: decodeMetadata(account.data) }), true)
