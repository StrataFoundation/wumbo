...
import { useBondingPricing, usePriceInUsd, useSolPrice } from "@strata-foundation/react";
...
const TierGradients:  Record<TokenTier, string> = {
  "Platinum": "linear-gradient(115.09deg, #BEDBEA 3.94%, #77ACCA 24.55%, #06141D 48.17%, #2FCFFF 86.38%)",
  "Gold": "",
  "Silver": ""
}
...
export function useTokenTier(tokenBonding: PublicKey | undefined | null): TokenTier | undefined {
  ...
  const found = Object.entries(TierCutoffs).reverse().find(([tier, value]) => 
  locked && locked >= value
  )
