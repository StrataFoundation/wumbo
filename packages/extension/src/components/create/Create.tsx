          ...
          {!userInfo && !loading && (
            <Text w="full" fontSize="small">
              <Text fontWeight="bold">
                If this is your twitter account, you can create your token or link your wallet 
                to Wum.bo for free.
              </Text>

              If this is someone else's twitter account, you can create and
              begin trading a token that they will have the option to claim later.
              Should the person opt out, no new tokens may be
