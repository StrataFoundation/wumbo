...
export const SOLCLOUT_TO_USD_MARKET = new PublicKey(
...
export const SOLCLOUT_INSTANCE_KEY: PublicKey = new PublicKey(
  "8npFtXdjpPoR5VJKJZHCyDVzcBNsBL98gaje8yYB47EW"
);
export const SOLCLOUT_PROGRAM_ID: PublicKey = new PublicKey(
  "5ZVrnbCBMoLcmuoJ2pXAS518fvjRQaLeYxpQGeffzE24"
);
...
export const KEYPAIR: Keypair = Keypair.fromSecretKey(Uint8Array.of(...key));
